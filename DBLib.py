...
class DB:
    ...
    def UpdateSparqScores():
        ...
        #Quarterbacks
        sql = "UPDATE Prospect SET sparqScore=82.1, UMockMeGrade=expertGrade+.321 Where LOWER(Lastname) = 'allen' AND LOWER(School) like 'wyoming%' AND LOWER(POS) IN('qb') AND DraftId=2"
        DB.ExecuteSQL(sql)
