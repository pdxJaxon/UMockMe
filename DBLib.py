        ...
        try:
            with con:
                ...
                if ("DATABASE_URL" in os.environ):
                    ...
                    print("1a1")
                    cur.execute("CREATE TABLE if not exists Prospect(ProspectId integer, lastName text, firstName text, pos text, height text, weight text, expertGrade real,DraftProjectedRound integer, DraftProjectedPick integer,uMockMeGrade real,school text, draftId int, PRIMARY KEY(ProspectId))")
                    print("1aq1")
    ...
    def PopulatePicks(sessionid,draftId=2):
        ...
        with con:
            ...
            if(draftId==1):
                ...
                cur.execute("INSERT INTO PICK VALUES(1,31,31,'PHI',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(1,32,32,'NE',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(2,31,63,'CLE',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(2,32,64,'NE',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(3,14,78,'WAS',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(3,31,95,'BUF',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(3,32,96,'NE',null,'{}','{}')".format(sessionid, theTime))

                # 4
                # 32
                cur.execute("INSERT INTO PICK VALUES(4,1,97,'CLE',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,2,98,'NYG',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,3,99,'HOU',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,4,100,'IND',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,5,101,'CHI',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,6,102,'DEN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,7,103,'NYJ',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,8,104,'TB',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,9,105,'DEN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,10,106,'OAK',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,12,107,'MIA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,13,108,'CIN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,14,109,'WAS',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,15,110,'GB',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,16,111,'CHI',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,17,112,'DAL',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,18,113,'DET',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,19,114,'BAL',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,20,115,'LAC',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,21,116,'SEA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,22,117,'BUF',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,23,118,'KC',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,24,119,'CLE',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,25,120,'LA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,26,121,'TEN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,27,122,'ATL',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,28,123,'NO',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,29,124,'SF',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,30,125,'JAX',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,31,126,'MIA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,32,127,'PHI',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,33,128,'PHI',null,'{}','{}')".format(sessionid, theTime))

                # 5
                # 32
                cur.execute("INSERT INTO PICK VALUES(5,1,129,'CLE',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,2,130,'NYG',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,3,131,'IND',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,4,132,'SEA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,5,133,'DEN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,6,134,'SF',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,7,135,'TB',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,8,136,'CHI',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,9,137,'SEA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,10,138,'NO',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,11,139,'PIT',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,12,140,'WAS',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,13,141,'GB',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,14,142,'CIN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,15,143,'ARI',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,16,144,'DET',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,17,145,'BAL',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,18,146,'LAC',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,19,147,'PHI',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,20,148,'NYJ',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,21,149,'BUF',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,22,150,'CLE',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,23,151,'LA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,24,152,'CAR',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,25,153,'TEN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,27,154,'DEN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,28,155,'NO',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,29,156,'PIT',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,30,157,'BUF',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,31,158,'MIN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,32,159,'PHI',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(5,33,160,'SEA',null,'{}','{}')".format(sessionid, theTime))


                # 6
                # 32
                cur.execute("INSERT INTO PICK VALUES(6,1,161,'CLE',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,2,162,'NYG',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,3,163,'HOU',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,4,164,'IND',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,5,165,'NYJ',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,6,166,'TB',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,7,167,'CHI',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,8,168,'DEN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,9,169,'MIA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,10,170,'SF',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,11,171,'OAK',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,12,172,'GB',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,13,173,'CIN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,14,174,'WAS',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,15,175,'NO',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,16,176,'BAL',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,17,177,'LAC',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,18,178,'OAK',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,19,179,'DAL',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,20,180,'LA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,21,181,'LA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,22,182,'KC',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,23,183,'CAR',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,24,184,'LA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,25,185,'TEN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,26,186,'ATL',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,28,187,'NO',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,29,188,'TB',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,30,189,'JAX',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,31,190,'MIN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,32,191,'PHI',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,33,192,'NE',null,'{}','{}')".format(sessionid, theTime))


                # 7
                # 32
                cur.execute("INSERT INTO PICK VALUES(7,1,193,'CLE',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,2,194,'NYG',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,3,195,'IND',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,4,196,'HOU',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,5,197,'MIA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,6,198,'CHI',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,7,199,'DEN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,8,200,'SEA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,9,201,'SF',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,10,202,'OAK',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,11,203,'MIA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,12,204,'JAX',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,13,205,'WAS',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,14,206,'GB',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,15,207,'ARI',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,16,208,'CAR',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,17,209,'SEA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,18,210,'DAL',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,19,211,'DET',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,20,212,'BAL',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,21,213,'CAR',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,22,214,'SF',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,23,215,'WAS',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,24,216,'CAR',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,25,217,'TEB',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,26,218,'ATL',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,27,219,'NO',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,28,220,'PIT',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,29,221,'JAX',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,30,222,'SEA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,31,223,'SEA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,32,224,'CIN',null,'{}','{}')".format(sessionid, theTime))
