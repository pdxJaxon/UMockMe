    ...
    def PopulatePicks(sessionid,draftId=2):
        ...
        with con:
            ...
            if(draftId==1):
                ...
                cur.execute("INSERT INTO PICK VALUES(4,23,123,'LAR',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(6,23,197,'LAR',null,'{}','{}')".format(sessionid, theTime))
