        ...
        try:
            with con:
                ...
                if ("DATABASE_URL" in os.environ):
                    ...
                    cur.execute("CREATE TABLE if not exists UserProspect(email varchar(75), ProspectId integer, expertGrade real, CONSTRAINT pkUserProspect PRIMARY KEY(email,ProspectId))")
