    ...
    def PopulatePicks(sessionid,draftId=2):
        ...
        with con:
            ...
            if(draftId==1):
                ...
                cur.execute("INSERT INTO PICK VALUES(1,23,23,'NE',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(4,2,102,'TB',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(4,8,108,'NYG',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(4,9,109,'WAS',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(4,13,113,'DEN',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(4,36,136,'LA',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(5,5,142,'WAS',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(5,12,149,'DEN',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(5,22,159,'OAK',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(5,36,173,'OAK',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(6,8,182,'ARI',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(6,18,192,'DAL',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(6,24,198,'NE',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(6,35,209,'MIA',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(6,36,210,'NE',null,'{}','{}')".format(sessionid, theTime))
                ...
                cur.execute("INSERT INTO PICK VALUES(7,7,225,'MIN',null,'{}','{}')".format(sessionid, theTime))
                cur.execute("INSERT INTO PICK VALUES(7,8,226,'SEA',null,'{}','{}')".format(sessionid, theTime))
